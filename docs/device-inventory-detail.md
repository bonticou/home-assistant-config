...
| `binary_sensor.ting_1_electrical_fire_hazard` | Ting 1 Electrical Fire Hazard | telemetry | whisker_ting |  | available |
| `binary_sensor.ting_1_fire_hazard` | Ting 1 Fire Hazard | telemetry | whisker_ting |  | available |
| `binary_sensor.ting_1_frozen_pipe_risk` | Ting 1 Frozen Pipe Risk | telemetry | whisker_ting |  | available |
| `binary_sensor.ting_1_learning_mode` | Ting 1 Learning Mode | telemetry | whisker_ting |  | available |
| `binary_sensor.ting_1_unverified_fire_hazard` | Ting 1 Unverified Fire Hazard | telemetry | whisker_ting |  | available |
...
| `sensor.ting_1_current_voltage` | Ting 1 Current voltage | telemetry | whisker_ting |  | available |
...
| `sensor.ting_1_hazard_status` | Ting 1 Hazard Status | telemetry | whisker_ting |  | available |
...
| `sensor.ting_1_voltage_high` | Ting 1 Voltage high | telemetry | whisker_ting |  | available |
| `sensor.ting_1_voltage_low` | Ting 1 Voltage low | telemetry | whisker_ting |  | available |
...
| `binary_sensor.ting_2_electrical_fire_hazard` | Ting 2 Electrical Fire Hazard | telemetry | whisker_ting |  | available |
| `binary_sensor.ting_2_fire_hazard` | Ting 2 Fire Hazard | telemetry | whisker_ting |  | available |
| `binary_sensor.ting_2_frozen_pipe_risk` | Ting 2 Frozen Pipe Risk | telemetry | whisker_ting |  | available |
| `binary_sensor.ting_2_learning_mode` | Ting 2 Learning Mode | telemetry | whisker_ting |  | available |
| `binary_sensor.ting_2_unverified_fire_hazard` | Ting 2 Unverified Fire Hazard | telemetry | whisker_ting |  | available |
...
| `sensor.ting_2_current_voltage` | Ting 2 Current voltage | telemetry | whisker_ting |  | available |
...
| `sensor.ting_2_hazard_status` | Ting 2 Hazard Status | telemetry | whisker_ting |  | available |
...
| `sensor.ting_2_voltage_high` | Ting 2 Voltage high | telemetry | whisker_ting |  | available |
| `sensor.ting_2_voltage_low` | Ting 2 Voltage low | telemetry | whisker_ting |  | available |
...
| Entity | Name | Role | Integration | Detail | Availability |
| --- | --- | --- | --- | --- | --- |
| `light.exterior_deck_lights` | Exterior Deck Lights | control | lutron_caseta |  | available |
...
| `event.front_door_ding` | Front Door Ding | telemetry | ring |  | unknown |
...
| Entity | Name | Role | Integration | Detail | Availability |
| --- | --- | --- | --- | --- | --- |
| `light.kitchen_coffee_bar` | Kitchen Coffee Bar | control | lutron_caseta |  | available |
...
| Entity | Name | Role | Integration | Detail | Availability |
| --- | --- | --- | --- | --- | --- |
| `light.kitchen_island` | Kitchen Island | control | lutron_caseta |  | available |
...
| Entity | Name | Role | Integration | Detail | Availability |
| --- | --- | --- | --- | --- | --- |
| `light.kitchen_main` | Kitchen Main | control | lutron_caseta |  | available |
...
| Entity | Name | Role | Integration | Detail | Availability |
| --- | --- | --- | --- | --- | --- |
| `light.kitchen_sink_light` | Kitchen Sink Light | control | lutron_caseta |  | available |
...
| Entity | Name | Role | Integration | Detail | Availability |
| --- | --- | --- | --- | --- | --- |
| `light.kitchen_table_lights` | Kitchen Table Lights | control | lutron_caseta |  | available |
...
| `event.mudroom_door_ding` | Mudroom Door Ding | telemetry | ring |  | unknown |
...
| Entity | Name | Role | Integration | Detail | Availability |
| --- | --- | --- | --- | --- | --- |
| `binary_sensor.45_chesnut_ridge_rd_armonk_connectivity` | 45  CRR Connectivity | telemetry | hydrawise |  | available |
| `sensor.45_chesnut_ridge_rd_armonk_daily_active_watering_time` | 45  CRR Daily active watering time | telemetry | hydrawise |  | available |
...
| Entity | Name | Role | Integration | Detail | Availability |
| --- | --- | --- | --- | --- | --- |
| `binary_sensor.casey_s_closet_battery` | Casey's Closet Battery | telemetry | unifiprotect | diagnostic | available |
| `binary_sensor.casey_s_closet_contact` | Casey's Closet Contact | telemetry | unifiprotect |  | unavailable |
| `binary_sensor.casey_s_closet_moisture` | Casey's Closet Moisture | telemetry | unifiprotect |  | unavailable |
| `binary_sensor.casey_s_closet_motion` | Casey's Closet Motion | telemetry | unifiprotect |  | available |
| `binary_sensor.casey_s_closet_tamper` | Casey's Closet Tamper | telemetry | unifiprotect |  | available |
| `button.casey_s_closet_clear_tamper` | Casey's Closet Clear tamper | control | unifiprotect |  | unknown |
...
| `number.casey_s_closet_motion_sensitivity` | Casey's Closet Motion sensitivity | control | unifiprotect | config | available |
| `select.casey_s_closet_mount_type` | Casey's Closet Mount type | control | unifiprotect | config | available |
| `select.casey_s_closet_paired_camera` | Casey's Closet Paired camera | control | unifiprotect | config | available |
| `sensor.casey_s_closet_alarm_sound_detected` | Casey's Closet Alarm sound detected | telemetry | unifiprotect |  | unavailable |
| `sensor.casey_s_closet_battery` | Casey's Closet Battery | telemetry | unifiprotect | diagnostic | available |
| `sensor.casey_s_closet_bluetooth_signal_strength` | Bluetooth signal strength | telemetry | unifiprotect | diagnostic | disabled |
| `sensor.casey_s_closet_humidity` | Casey's Closet Humidity | telemetry | unifiprotect |  | unavailable |
| `sensor.casey_s_closet_illuminance` | Casey's Closet Illuminance | telemetry | unifiprotect |  | unavailable |
...
| `sensor.casey_s_closet_temperature` | Casey's Closet Temperature | telemetry | unifiprotect |  | unavailable |
| `sensor.casey_s_closet_uptime` | Uptime | telemetry | unifiprotect | diagnostic | disabled |
| `switch.casey_s_closet_alarm_sound_detection` | Casey's Closet Alarm sound detection | control | unifiprotect | config | available |
| `switch.casey_s_closet_humidity_sensor` | Casey's Closet Humidity sensor | control | unifiprotect | config | available |
| `switch.casey_s_closet_light_sensor` | Casey's Closet Light sensor | control | unifiprotect | config | available |
| `switch.casey_s_closet_motion_detection` | Casey's Closet Motion detection | control | unifiprotect | config | available |
| `switch.casey_s_closet_status_light` | Casey's Closet Status light | control | unifiprotect | config | available |
| `switch.casey_s_closet_temperature_sensor` | Casey's Closet Temperature sensor | control | unifiprotect | config | available |
...
| `media_player.unnamed_room_2` | Office | control | sonos |  | available |
...
| `sensor.u7_pro_outdoor_cpu_utilization` | CPU utilization | telemetry | unifi | diagnostic | unavailable |
| `sensor.u7_pro_outdoor_memory_utilization` | Memory utilization | telemetry | unifi | diagnostic | unavailable |
...
| `sensor.u7_pro_outdoor_uptime` | U7 Pro Outdoor Uptime | telemetry | unifi | diagnostic | unknown |
...
| `sensor.zone_1_daily_active_watering_time` | Zone 1 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_10_daily_active_watering_time` | Zone 10 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_11_daily_active_watering_time` | Zone 11 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_12_daily_active_watering_time` | Zone 12 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_13_daily_active_watering_time` | Zone 13 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_14_daily_active_watering_time` | Zone 14 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_15_daily_active_watering_time` | Zone 15 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_16_daily_active_watering_time` | Zone 16 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_17_daily_active_watering_time` | Zone 17 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_18_daily_active_watering_time` | Zone 18 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_19_daily_active_watering_time` | Zone 19 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_2_daily_active_watering_time` | Zone 2 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_20_daily_active_watering_time` | Zone 20 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_21_daily_active_watering_time` | Zone 21 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_22_daily_active_watering_time` | Zone 22 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_23_daily_active_watering_time` | Zone 23 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_24_daily_active_watering_time` | Zone 24 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_25_daily_active_watering_time` | Zone 25 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_26_daily_active_watering_time` | Zone 26 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_27_daily_active_watering_time` | Zone 27 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_3_daily_active_watering_time` | Zone 3 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_4_daily_active_watering_time` | Zone 4 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_5_daily_active_watering_time` | Zone 5 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_6_daily_active_watering_time` | Zone 6 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_7_daily_active_watering_time` | Zone 7 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_8_daily_active_watering_time` | Zone 8 Daily active watering time | telemetry | hydrawise |  | available |
...
| `sensor.zone_9_daily_active_watering_time` | Zone 9 Daily active watering time | telemetry | hydrawise |  | available |
...
| `binary_sensor.ratgdo32_4536e8_motion` | ratgdo32 4536e8 Motion | telemetry | esphome |  | available |
| `binary_sensor.ratgdo32_4536e8_obstruction` | ratgdo32 4536e8 Obstruction | telemetry | esphome |  | available |
| `button.ratgdo32_4536e8_query_status` | ratgdo32 4536e8 Query status | control | esphome | diagnostic | unknown |
| `button.ratgdo32_4536e8_restart` | ratgdo32 4536e8 Restart | control | esphome | config | unknown |
| `button.ratgdo32_4536e8_safe_mode_boot` | ratgdo32 4536e8 Safe mode boot | control | esphome | diagnostic | unknown |
...
| `cover.ratgdo32_4536e8_door` | Trevor's garage door | control | esphome |  | available |
...
| `number.ratgdo32_4536e8_closing_duration` | ratgdo32 4536e8 Closing duration | control | esphome | config | available |
| `number.ratgdo32_4536e8_opening_duration` | ratgdo32 4536e8 Opening duration | control | esphome | config | available |
| `number.ratgdo32_4536e8_rolling_code_counter` | ratgdo32 4536e8 Rolling code counter | control | esphome | config | unknown |
| `sensor.ratgdo32_4536e8_firmware_version` | ratgdo32 4536e8 Firmware Version | telemetry | esphome | diagnostic | available |
| `sensor.ratgdo32_4536e8_wifi_signal` | ratgdo32 4536e8 WiFi Signal | telemetry | esphome | diagnostic | available |
...
| `cover.ratgdo32disco_c26634_door` | Casey's garage door | control | esphome |  | available |
...
| `number.ratgdo32disco_c26634_closing_delay` | ratgdo32disco c26634 Closing Delay | control | esphome | config | unknown |
...
| `input_datetime.metro_north_commute_last_notified_at` | Metro-North Commute Last Notified At | control | input_datetime | available |
...
| `script.away_security_close_open_garage_doors` | Away Security Close Open Garage Doors | other | script | available |
